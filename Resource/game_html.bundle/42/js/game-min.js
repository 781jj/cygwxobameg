...
liebaoPlatformShare={
    ua:function(){
        var ua= navigator.userAgent,type="pc";
        if(/MicroMessenger/gi.test(ua)){
        	type="weixin";
        }else if(/Gkuwan/gi.test(ua)){
        	type="kuwan";
        }else if(/CM/gi.test(ua)){
        	type="cm"
        }
        return type;
    },
    updateData:function(obj,wx){
   

    },
    weixinFun:function(obj,wx){
	...
	CompanyContainer = function(d) {
		...
		c.prototype.onAddToStage = function(b) {
			...
			egret.Tween.get(b).to({
				...
				alpha: 0
			}, 10).call(this.tweenComplete, this);
	...
	GameApp = function(d) {
		...
		c.prototype.onAddToStage = function(b) {
			...
			/*WeixinApi.ready(function(a) {
				...
				b.title = "\u662f\u7537\u4eba\u5c31\u4e0b100\u5c42";
				b.desc = "\u662f\u7537\u4eba\u5c31\u4e0b100\u5c42\uff0c\u5728\u5fae\u4fe1\u5e73\u53f0\u4e0a\u7ecf\u5178\u91cd\u73b0!\u6b64\u6b3e\u6e38\u620f\u9700\u8981\u4f60\u6709\u826f\u597d\u7684\u5fc3\u91cc\u7d20\u8d28,\u654f\u9510\u7684\u89c2\u5bdf\u529b\u548c\u7075\u6d3b\u7684\u624b\u6307\u64cd\u63a7\u53cd\u5e94\uff01\u5206\u4eab\u7ed9\u597d\u53cb\uff0c\u770b\u770b\u8c01\u66f4\u5f3a\uff01";
				b.link = "http://www.liebao.cn/game/jxybc/?f=wx";
				b.imgUrl = "http://www.liebao.cn/game/jxybc/assets/sharePic.jpg";
				a.shareToTimeline(b);
				a.shareToFriend(b)
			})*/
		};
		...
		c.prototype.dead = function() {
			...
			//this.socres.push(c.currentFloors);
			this.socres.push(blayer);
            this.socres.sort();
            //this.bestValueText.text = this.socres[this.socres.length - 1] + "\u5c42";
            //this.scoreValueText.text = c.currentFloors + "\u5c42";
            var best = localStorage.best || 0;
            if(blayer*1 > best*1){
                localStorage.best = best = blayer;
            }
            this.bestValueText.text = best + " floor";
            this.scoreValueText.text = blayer + " floor";

//            this.urlloader = new egret.URLLoader;
//            this.urlloader.addEventListener(egret.Event.COMPLETE, this.onPostComplete, this);
//            var b = new egret.URLRequest;
//            b.url = "http://wityun.com/api/v1/man100/score";
//            b.method = egret.URLRequestMethod.POST;
//            "" == this.tempUID && (this.tempUID = this.randomString(24));
//            b.data = new egret.URLVariables("uid=" + this.tempUID + "&score=" + c.currentFloors);
//            //console.log(b.data);
//            this.urlloader.load(this)
            this.onPostComplete(this);
            //weixinshare
            

            window.__score__ = {
                score: GameApp.currentFloors
            }
            if ( window.Android ) {
            ...
            //_hmt.push(["_trackEvent", "button", "gameover","scores-"+GameApp.currentFloors]);
			displayFooter(true);
			
		};
		c.prototype.onPostComplete = function(b) {
//            b = this;
//			this.urlloader.removeEventListener(egret.Event.COMPLETE, this.onPostComplete,
//				this);
			//b = JSON.parse(b.target.data);
		...
		c.prototype.initStartLayer = function() {
			...
			d.text = "Click the right part of screen to right";
			...
			a.text = "Click the left part of screen to left";
		...
		c.prototype.goHome = function(b) {
            return
			//window.location.href = "http://www.liebao.cn/game/jxybc?f=gamecenter"
		};
		...
		c.prototype.onStartGame = function(b) {
			//_hmt.push(["_trackEvent", "button", "start"]);
			displayFooter(false);
		...
		c.prototype.onReplay = function(b) {
			displayFooter(false);
			//_hmt.push(["_trackEvent", "button", "replay"]);
			this.endLayer.visible = !1;
			this.gameOver();
			this.gameStart()
		};
...
//            xb.y =600;
		...
		c.prototype.updateFloors = function(b) {
			...
			10 == c.currentFloors ? this.distributeStepsRatio(this.ratio1 - 10, this.ratio2 + 3, this.ratio3 + 3, this.ratio4 + 2, this.ratio5 + 1, this.ratio6 + 1) : 20 == c.currentFloors ? (c.speed += 0.001, this.distributeStepsRatio(this.ratio1 - 10, this.ratio2 + 2, this.ratio3 + 2, this.ratio4 + 2, this.ratio5 + 2, this.ratio6 + 2)) : 30 == c.currentFloors ?
				(c.speed += 0.000, this.distributeStepsRatio(this.ratio1 - 15, this.ratio2 + 3, this.ratio3 + 3, this.ratio4 + 3, this.ratio5 + 3, this.ratio6 + 3)) : 40 == c.currentFloors ? (c.speed += 0.001, this.distributeStepsRatio(this.ratio1 - 20, this.ratio2 + 4, this.ratio3 + 4, this.ratio4 + 4, this.ratio5 + 4, this.ratio6 + 4)) : 50 == c.currentFloors ? (c.speed += 0.000, this.distributeStepsRatio(this.ratio1 - 25, this.ratio2 + 5, this.ratio3 + 5, this.ratio4 + 5, this.ratio5 + 5, this.ratio6 + 5)) : 70 == c.currentFloors ? (c.speed += 0.003, this.distributeStepsRatio(this.ratio1 - 30, this.ratio2 +
				6, this.ratio3 + 6, this.ratio4 + 6, this.ratio5 + 6, this.ratio6 + 6)) : 90 == c.currentFloors && (c.speed += 0.005, this.distributeStepsRatio(this.ratio1 - 35, this.ratio2 + 7, this.ratio3 + 7, this.ratio4 + 7, this.ratio5 + 7, this.ratio6 + 7))
		};
