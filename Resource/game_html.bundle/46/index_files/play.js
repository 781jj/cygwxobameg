...
play.init = function(a) {
	...
	com.canvas.addEventListener(document.hasOwnProperty("ontouchstart") ? "touchstart" : "click", play.clickCanvas),
	com.get("regretBtn").innerHTML = "悔   棋(" + play.regretCount + ")", com.get("regretBtn").style.opacity = 1
