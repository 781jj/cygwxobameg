...
(function(){
    ...
    publicResourceLoader =new PublicResourceLoader({
        css:['noonedie_files/index.css?version='+Math.random()],
        scripts:[
            'noonedie_files/jquery.min.js',
            'noonedie_files/server.js?version='+Math.random(),
            'noonedie_files/adSceneInGames.js?version='+Math.random(),
            'noonedie_files/game_index.js?version='+Math.random()
        ]
    });
}());
