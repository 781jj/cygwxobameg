dp_submitScore = function (m, s) {
	...
	// 		bestTime: s,
	// 		og: {
	// 			title: "Your mission:no one dies."
	// 		}
	// 	})
	// }, 1000);

    var mod = ['Easy', 'Normal', 'Hard', 'Hardest'];
    setTimeout(function(){
        window.__score__ = {
            gameModule: mod[m-2],
            time: parseFloat(s) / 1000
        }
        if ( window.Android ) {
...
var link, jsGame; (function() {
    ...
    String.format || (String.format = function() {
        ...
        t;
        for (var n = 1,
        r = arguments.length; n < r; n++) t = new RegExp("\\{" + (n - 1) + "\\}", "gm"),
    ...
    Array.prototype.indexOfAttr = function(e, t) {
        ...
        r = -1;
        for (var i = 0,
        s = this.length; i < s; i++) if (n == "string" && this[i][e] == t || n == "number" && this[i] == e) {
            r = i;
            break
        }
        return n = null,
    ...
    link = {
        init: function(e, t) {
            return ! e && !t ? (this.version = 1, this.request.init(), this.canvas.initDevice(), this.localStorage.init(), this.sessionStorage.init()) : (n.canvas.defaultWidth = e, n.canvas.defaultHeight = t),
            this
        },
        extend: t,
        setAjax: function(e) {
            return n.ajax.param = this.objExtend(n.ajax.param, e || {}),
            this
        },
        ajax: function(e) {
        ...
        comm: {
            ...
            getArray: function(e, t) {
                v.arr = [],
                v.len = e.toString().length,
                v.v = e;
                for (var n = 0; n < v.len; n++) v.arr.push(v.v % 10),
                v.v = parseInt(v.v / 10);
                return t || v.arr.reverse(),
                v.arr
            },
            ...
            rect2CircleCollision: function(e, t, n, r, i, s, o) {
                var u = !1;
                return (u = this.circleCollision(e, t, 1, i, s, o)) || (u = this.circleCollision(e + n, t, 1, i, s, o)) || (u = this.circleCollision(e + n, t + r, 1, i, s, o)) || (u = this.circleCollision(e, t + r, 1, i, s, o)) || (u = this.collision(e, t, n, r, i - (o >> 1), s - (o >> 1), o, o)),
                u
            },
        ...
        menu: function(e) {
            return typeof e == "function" && (n.system.menu = e),
            this
        },
        run: function(e) {
            return typeof e == "function" && (n.system.runFn = e),
            this
        },
        stop: function(e) {
            return typeof e == "function" && (n.system.stop = e),
            this
        },
        over: function(e) {
            return typeof e == "function" && (n.system.over = e),
            this
        },
        zone: function(e) {
            return typeof e == "function" && (n.system.zone = e),
            this
        },
        active: function(e) {
            return typeof e == "function" && (n.system.active = e),
            this
        },
        play: function() {
            return n.system.run || (n.system.run = function() {
                ...
                case r.system.gameFlowType.loadImage:
                    if (i.loadingCallBack != null) {
                        ...
                        s == t && i.loadingEndCallBack && (i.loadingEndCallBack(s, t, "image"), i.loadingEndCallBack = null),
                        s = t = null
                    }
                    break;
            ...
            n.system.playTimer || (n.system.isPause = !1, (n.system.rafRun = function() {
                var e = Date.now();
                e - n.system.lastDate >= n.system.timeout - n.system.spendTime && (n.system.lastDate = e, n.system.isPause || n.system.run()),
                e = null,
        ...
        pause: function() {
            return n.system.playTimer && (n.system.isPause = !0, n.system.rafRun = null, cancelAnimationFrame(n.system.playTimer), n.system.playTimer = null),
            this
        },
        gameFlow: {
            menu: function() {
                return n.system.menu != null && (n.system.gameFlow = r.system.gameFlowType.menu, m.resetKeys()),
                this
            },
            run: function() {
                return n.system.runFn != null && (n.system.gameFlow = r.system.gameFlowType.run, m.resetKeys()),
                this
            },
            stop: function() {
                return n.system.stop != null && (n.system.gameFlow = r.system.gameFlowType.stop, m.resetKeys()),
                this
            },
            over: function() {
                return n.system.over != null && (n.system.gameFlow = r.system.gameFlowType.over, m.resetKeys()),
                this
            },
            zone: function(e) {
                return n.system.zone != null && (n.system.gameFlow = r.system.gameFlowType.zone, n.system.zoneArgs = e, m.resetKeys()),
                this
            },
            active: function(e) {
                return n.system.active != null && (n.system.gameFlow = r.system.gameFlowType.active, n.system.activeArgs = e, m.resetKeys()),
                this
            },
            isIn: function(e) {
        ...
        canvas: {
            ...
            del: function(e) {
                return n.canvas.ctxs[e] && (n.canvas.ctxs[e] = null, delete n.canvas.ctxs[e], n.canvas.cavansDoms[e] = null, delete n.canvas.cavansDoms[e]),
                this
            },
            ...
            screen: {
                ...
                setWidth: function(e) {
                    return n.canvas.defaultWidth = e,
                    c && (c.width = n.canvas.defaultWidth, c.style.width = c.width + "px", p = parseInt(c.width)),
                    this
                },
                getHeight: function() {
                    return d
                ...
                setHeight: function(e) {
                    return n.canvas.defaultHeight = e,
                    c && (c.height = n.canvas.defaultHeight, c.style.height = c.height + "px", d = parseInt(c.height)),
                    this
                },
                getDevice: function() {
            ...
            setColor: function(e, t, n) {
                return n == null ? (u.fillColor = e, u.strokeColor = t ? t: e) : (u.fillColor = "rgb(" + e + ", " + t + ", " + n + ")", u.strokeColor = u.fillColor),
            ...
            drawImage: function(e, t, r, u, a, f, l, c, h, p) {
                ...
                else if (d.src != null) c != null && (t = t < 0 ? 0 : t, c = c <= 0 ? .1 : c),
                h != null && (r = r < 0 ? 0 : r, h = h <= 0 ? .1 : h),
                u != null && c != null && (u = u <= 0 ? .1 : t + u <= d.width ? u: d.width - t),
                a != null && h != null && (a = a <= 0 ? .1 : r + a <= d.height ? a: d.height - r),
                d.loaded && (u ? a ? p ? (o = i.getAnchor(f, l, c, h, p), s.drawImage(d, t, r, u, a, o.x, o.y, c, h)) : s.drawImage(d, t, r, u, a, f, l, c, h) : (o = i.getAnchor(t, r, d.width, d.height, u), s.drawImage(d, o.x, o.y)) : s.drawImage(d, t, r));
                else {
            ...
            drawCache: function(e, t, r, u, a, f, l, c, h, p) {
                ...
                return d && (c != null && (t = t < 0 ? 0 : t, c = c <= 0 ? .1 : c), h != null && (r = r < 0 ? 0 : r, h = h <= 0 ? .1 : h), u != null && c != null && (u = u <= 0 ? .1 : t + u <= d.width ? u: d.width - t), a != null && h != null && (a = a <= 0 ? .1 : r + a <= d.height ? a: d.height - r), u ? a ? p ? (o = i.getAnchor(f, l, c, h, p), s.drawImage(d, t, r, u, a, o.x, o.y, c, h)) : s.drawImage(d, t, r, u, a, f, l, c, h) : (o = i.getAnchor(t, r, d.width, d.height, u), s.drawImage(d, o.x, o.y)) : s.drawImage(d, t, r)),
                d = null,
                this
            },
            ...
            drawNumber: function(e, t, n, r, i, s, o, u, a) {
                ...
                if (o == "center") {
                    ...
                    d = null
                } else if (o == 1) for (var v = 0; v < l; v++) this.drawImage(t, parseInt(f.charAt(v)) * n, 0, n, r, i + v * c, s, c, h);
                else if (o == 0) for (var v = l - 1; v >= 0; v--) this.drawImage(t, parseInt(f.charAt(v)) * n, 0, n, r, i - (l - 1 - v) * c, s, c, h, m.graphics.ANCHOR_RT);
                return h = null,
                c = null,
                l = null,
                f = null,
            ...
            arc: function(e, t, n, r, i, o) {
                return s.arc(e, t, n, r, i, o),
                this
            },
            quadraticCurveTo: function(e, t, n, r) {
                return s.quadraticCurveTo(e, t, n, r),
                this
            },
            bezierCurveTo: function(e, t, n, r, i, o) {
                return s.bezierCurveTo(e, t, n, r, i, o),
                this
            },
            ...
            drawString: function(e, t, i, o, u, a, f, c) {
                ...
                return u && (a ? l.fillStyle = a: l.fillStyle = "#000000", f ? l.strokeStyle = f: l.strokeStyle = "#CCCCCC", this.fillStyle(l.strokeStyle).fillText(e, l.x + 1, l.y + 1, c).fillStyle(l.fillStyle)),
            ...
            setTransform: function(e, t, n, r, i, o) {
                return s.setTransform(e, t, n, r, i, o),
                this
            },
            scale: function(e, t) {
                return s.scale(e, t),
        ...
        pushImage: function(e, t) {
            ...
            var r;
            for (var i = 0,
            s = e.length; i < s; i++) r = e[i],
            r && !n.image.initImgs[r.id] && (n.image.initImgs[r.id] = !0, n.image.imgObjs.push(e[i]));
        ...
        loadImage: function(e, t) {
            if (n.system.gameFlow != r.system.gameFlowType.loadImage && e.length > 0) {
                ...
                n.image.countLoaded = 0;
                for (var s = 0,
                o; o = n.image.imgObjs[s]; s++) n.image.imgs[o.id] ? n.image.countLoaded++:i.setImage(o.id, o.src, o.benchId);
        ...
        asyncImage: function(e) {
            var t;
            for (var r = 0,
            i = e.length; r < i; r++) t = e[r] || {},
            n.image.asyncImgObjs[t.id] || (n.image.asyncImgObjs[t.id] = t);
            return t = null,
            this
        },
        verImage: function(e) {
            return n.image.version == "" && (n.image.version = e),
            this
        },
        loadingCallBack: function(e) {
            return typeof e == "function" && (i.loadingCallBack = e),
            this
        },
        loadingEndCallBack: function(e) {
            return typeof e == "function" && (i.loadingEndCallBack = e),
            this
        },
        addImage: function(e, t) {
            return e && t && !n.image.imgs[e] && (n.image.imgs[e] = t),
            this
        },
        getImage: function(e) {
        ...
        clearAsyncImageCache: function() {
            try {
                ...
                t && (r = n.image.asyncImgObjs[i], r && (r.inited = !1, this.delImage(i).canvas.del(i)));
                e = t = r = null
            } catch(s) {}
            return this
        },
        ...
        buttonLayout: {
            ...
            destroy: function(e) {
                ...
                r;
                for (var i = t.length - 1; i >= 0; i--) if (r = t[i]) if (r.id == e) {
                    r.disposed(),
                    t.splice(i, 1);
                    break
                }
    ...
    return {
        init: function() {
            ...
            e.run(function() {
                ...
                e.buttonLayout.released("difficulty1") ? (l.moduleName = "Easy", c(2)) : e.buttonLayout.released("difficulty2") ? (l.moduleName = "ormal", c(3)) : e.buttonLayout.released("difficulty3") ? (l.moduleName = "Hard", c(4)) : e.buttonLayout.released("difficulty4") ? (l.moduleName = "Hardest", c(5)) : e.buttonLayout.released("rank") && dp_Ranking()
            }).zone(function() {
                e.canvas.fillStyle("#F00").fillScreen().fillStyle("#FFF").drawString(l.moduleName, 0, u + 110, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑").drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 555, 480, 7).fillStyle("#000").drawString(a(l.time, "S"), 0, u + 340, e.graphics.VCENTER, !1, null, null, "60px 微软雅黑").fillStyle("#000").drawString("Best:" + a(l.bestTime, ""), 0, u + 400, e.graphics.VCENTER, !1, null, null, "30px 微软雅黑"),
                l.time > l.bestTime && e.canvas.fillStyle("#FF0").drawString("New record", 0, u + 240, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑"),
                e.buttonLayout.released("return") ? f() : e.buttonLayout.released("restart") && c(l.module)
            ...
            var l = {
                ...
                null, {
                    ...
                    touchStart: function(t, n) {
                        return this.host.endPath() ? (e.comm.collision(t, n, 1, 1, this.x, this.baseY - this.height, this.width, this.height) && (
                        /*e.audio.play("1"),*/
                        this.host.setPath([[0, -20], [0, -20], [0, -20], [0, -10], [0, -10], [0, -10], [0, -5], [0, -5], [0, -5], [0, 5], [0, 5], [0, 5], [0, 10], [0, 10], [0, 10], [0, 20], [0, 20], [0, 20]])), this) : this
                    }
                })
            },
            c = function(t) {
            ...
            h = function() {
                ...
                //dp_getGameResulte(l.module, l.time * (l.module - 1),
//                 function(resulte) {
//                     if (resulte.rank > 0 && resulte.rank <= 100) if (!resulte.concern) {
// }
                // },
                // 0);
            }
