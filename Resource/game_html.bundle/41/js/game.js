...
(function (t) {
    ...
    function p(t, n, r, o, a) {
        this.version = "0.9.4", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new t({
            isMaster: !0
    ...
    (function (t) {
        ...
        function c(t, e, n) {
            return function () {
                return "undefined" != typeof console && "function" == typeof console.warn && console.warn(e + " is deprecated, use " + n + " instead.", Error("")
                    .stack), t.apply(t, arguments)
            }
        }
        ...
        function l() {
            ...
            if (o.promiseDispatch = function (t, r, o) {
                var a = Q(arguments);
                n ? (n.push(a), "when" === r && o[1] && i.push(o[1])) : H(function () {
        ...
        function f(t) {
            return h(function (e, n) {
                for (var i = 0, r = t.length; r > i; i++) p(t[i])
                    .then(e, n)
            })
        }
        ...
        function _(t) {
            return y(t) && "pending" === t.inspect()
                .state
        }

        function S(t) {
            return !y(t) || "fulfilled" === t.inspect()
                .state
        }

        function b(t) {
            return y(t) && "rejected" === t.inspect()
                .state
        }
            ...
            return function () {
                function e(t, e) {
                    ...
                    if ("undefined" == typeof StopIteration) {
                        ...
                        return a.done ? a.value : m(a.value, r, o)
                    }
                    try {
                        a = i[t](e)
                    } catch (s) {
        ...
        function x(t) {
            return m(t, function (t) {
                ...
                return Y(t, function (i, r, o) {
                    var a;
                    y(r) && "fulfilled" === (a = r.inspect())
                        .state ? t[o] = a.value : (++e, m(r, function (i) {
        ...
        p.resetUnhandledRejections = w, p.getUnhandledReasons = function () {
            ...
            return void 0 === e && (e = t, t = void 0), p(t)
                .delay(e)
            ...
            var e = l(),
                n = Q(t);
            return n.push(e.makeNodeResolver()), this.fapply(n)
            ...
            var t = Q(arguments),
                e = l();
            return t.push(e.makeNodeResolver()), this.fapply(t)
                .fail(e.reject), e.promise
            ...
            return function () {
                var n = e.concat(Q(arguments)),
                    i = l();
                return n.push(i.makeNodeResolver()), p(t)
                    .fapply(n)
            ...
            return function () {
                ...
                var r = n.concat(Q(arguments)),
                    o = l();
                return r.push(o.makeNodeResolver()), p(i)
                    .fapply(r)
            ...
            var n = Q(e || []),
                i = l();
            return n.push(i.makeNodeResolver()), this.dispatch("post", [t, n])
                .fail(i.reject), i.promise
            ...
            var e = Q(arguments, 1),
                n = l();
            return e.push(n.makeNodeResolver()), this.dispatch("post", [t, e])
    ...
    f.argsToArray = function (t) {
        ...
        return /play68.com/.test(window.location.host)
    }, f.getRole = function () {
    ...
    d.getGameConfig = function () {
        ...
        e.JSLib = {
            ...
            if (t[0] && "string" == typeof t[0]) e.JSLib.publish(t[0], t[1] || null);
                ...
                var n, i, r = [];
                for (n = 0, i = t[0].length; i > n; n++) r.push(e[t[0][n]]);
                t[1].apply(this, r)
            }
        }, t.call(this, {
        ...
        (this.IS_SLAVE || f.isWrapped()) && this.startInternalTracking(e, n, i)
        ...
        return n = this._getLink("logo"), t && "object" == typeof t && (i = f.validateSchema(r, t), i.error && (n.error = i.error)), n
        ...
        if (this.data && this.data.branding && this.data.branding.splash_screen) {
            ...
            this.data.branding.splash_screen.image || this.data.branding.splash_screen.url || (n = !1), t = {
                show: n,
                action: this._getLink("splash_screen")
                    .action || function () {}
            }
        } else t = {
            show: !0,
        ...
        var i, r;
        i = f.isArray(t) && "function" == typeof t[t.length - 1] ? this._callbacks.push(t.pop()) - 1 : e, r = new s({
                type: n || "jslib",
                callbackId: i,
                data: t
            })
        ...
        function e(e) {
            return i.IS_MASTER && (e = n(e)), i.isReady = !0, i.Branding.moduleReady = !0, i.__.EventTracking.moduleReady = !0, i.GameBreak.moduleReady = !0, i.Game.moduleReady = !0, i.Branding.init({
                data: e
            }), i.__.EventTracking.init({
                data: e
            }), i.GameBreak.init(), i.__.messenger._postMessage(["log.gameapi.loadapi.finish", {
                    origin: r,
                    version: i.version
                },
                null
        ...
        var i = this,
            r = this.IS_MASTER ? "master" : "slave";
        return !0 === this.isReady ? (window.console && window.console.log && console.log("WARNING: Detected multiple executions of GameAPI.loadAPI(). This method should only be executed once per page load!"), t(i)) : (this.__.messenger._postMessage(["log.gameapi.loadapi.start", {
                    origin: r,
                    version: i.version
                },
                null
            ], null, "log"), this.IS_STANDALONE ? d.setupStandaloneMode(function (t) {
                i.__.dataStore._setCache(n(t)), e(t)
            }) : this.IS_MASTER ? d.getGameConfig()
            .then(function (t) {
                d.getBrandingConfig(t)
                    .then(function (r) {
                        t && !t.isError && (t.branding = r.branding, i.__.dataStore._setCache(n(t))), e(t)
                    })
            }) : this.__.messenger.requestFromParent("GameAPI.data", {}, function (t) {
                e(t)
            }), void 0)
    };
    var m = new p(n, c, a, o, r);
