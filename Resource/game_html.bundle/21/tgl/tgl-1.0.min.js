/* TreSensa Game Loader, TGL-SDK, Version 1.0.34 */
...
TGL.Init = function(a) {
    if (this._sConfig = a, "number" == typeof a.LOG_LEVEL && (TGL.Debug.LogLevel = a.LOG_LEVEL), TGL.Debug.Log(TGL.Debug.LOG_INFO, "TreSensa TGL GameLoader started"), a.DEBUG = "undefined" != typeof a.DEBUG ? a.DEBUG: !1, a.DEBUG && TGL.Debug.Log(TGL.Debug.LOG_WARNING, "Debug mode enabled"), a.hasOwnProperty("LIB_DIR") && TGL.Debug.Log(TGL.Debug.LOG_WARNING, "GameConfig.LIB_DIR in use. Local copies of the TreSensa libraries will be used."), a.NATIVE_APP = !("undefined" == typeof CordovaConfig), a.TIZEN_APP = !("undefined" == typeof TizenConfig), a.NATIVE_APP && TGL.Debug.Log(TGL.Debug.LOG_INFO, "Native app detected"), a.TIZEN_APP && TGL.Debug.Log(TGL.Debug.LOG_INFO, "Tizen app detected"), a.hasOwnProperty("TGE") ? a.TGE.ENABLED = "undefined" != typeof a.TGE.ENABLED ? a.TGE.ENABLED: !0 : a.TGE = {
        ENABLED: !1
    },
    a.hasOwnProperty("TGS") ? a.TGS.ENABLED = "undefined" != typeof a.TGS.ENABLED ? a.TGS.ENABLED: !0 : a.TGS = {
        ENABLED: !1
    },
    ...
    } ! a.DEBUG && a.PROD_ENV || "undefined" != typeof a.SOURCE && 0 != a.SOURCE.length || (TGL.Debug.Log(TGL.Debug.LOG_WARNING, "GameConfig.SOURCE is missing or empty. For best results include all your source files in GameConfig.SOURCE rather than manually loading them."), a.SOURCE = []),
    ...
    a.hasOwnProperty("ADS") ? ("undefined" != typeof a.ADS.GAMEOVER_PLACEMENT_ID && (a.ADS.DISPLAY_PLACEMENT_ID = a.ADS.GAMEOVER_PLACEMENT_ID), a.ADS.DISPLAY_PLACEMENT_ID = "undefined" != typeof a.ADS.DISPLAY_PLACEMENT_ID && "" != a.ADS.DISPLAY_PLACEMENT_ID ? a.ADS.DISPLAY_PLACEMENT_ID: "3140258", a.ADS.INTERSTITIAL_PLACEMENT_ID = "undefined" != typeof a.ADS.INTERSTITIAL_PLACEMENT_ID && "" != a.ADS.INTERSTITIAL_PLACEMENT_ID ? a.ADS.INTERSTITIAL_PLACEMENT_ID: "3140259", a.ADS.INTERSTITIAL_INTERVAL = "undefined" != typeof a.ADS.INTERSTITIAL_INTERVAL ? a.ADS.INTERSTITIAL_INTERVAL: 150) : (a.ADS = {
        DISPLAY_PLACEMENT_ID: "3140258",
        INTERSTITIAL_PLACEMENT_ID: "3140259",
    ...
    a.TGS.HOST = a.PROD_ENV ? "undefined" != typeof a.TGS.HOST ? a.TGS.HOST: "": "",
    ...
    TGL.SDKBaseURL = a.DEBUG ? "js/lib-debug/": a.NATIVE_APP || a.TIZEN_APP ? "js/lib/": a.LIB_DIR ? a.LIB_DIR: "file:" == location.protocol ? "http:" + d + "/": a.LIB_DIR,
    TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "TGL.SDKBaseURL = " + TGL.SDKBaseURL),
    ...
    a.MoreGames = {},
    a.MoreGames.URL = TGL.getMoreGamesURL(),
    a.MoreGames.ENABLED = !!a.MoreGames.URL,
    ...
    } (window, document, "script", ""/*google 统计js 删除*/, "_gaTreSensa"), TGL.Debug.Log(TGL.Debug.LOG_INFO, "Google Analytics loaded")),
    ...
    a.NATIVE_APP || a.TIZEN_APP || !a.Bugsense.ENABLED || (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Bugsense enabled. Using API_KEY = " + a.Bugsense.API_KEY), c.push(TGL.SDKBaseURL + "tgl/3rdparty/bugsense.2.0.1" + TGL.MinifiedSuffix + ".js")),
    ...
    head.ready(function() {
        ...
        var b = {
            phaser: ["./plugins/phaser/tgshelper.js"]
        },
        c = (a.ENGINE || "TGE").toLowerCase();
        b[c] ? head.load(b[c], TGL.setEventListeners) : TGL.setEventListeners()
    })
},
TGL.setEventListeners = function() {
    GameConfig.NATIVE_APP || !GameConfig.GoogleAnalytics.ENABLED || GameConfig.GoogleAnalytics.STUDIO_ONLY || (_gaTreSensa("create", GameConfig.PROD_ENV ? "UA-29301358-66": "UA-29301358-8", "auto", {
        name: "TGLTracker"
    }), _gaTreSensa("TGLTracker.send", {
        hitType: "pageview",
        dimension1: TGL.getDistributionPartner(),
        dimension2: GameConfig.VERSION,
        dimension3: GameConfig.GAME_ID
    })),
    GameConfig.NATIVE_APP || GameConfig.TIZEN_APP || !GameConfig.Bugsense.ENABLED || (Bugsense.initAndStartSession({
        apiKey: GameConfig.Bugsense.API_KEY,
        appversion: GameConfig.VERSION,
        appname: GameConfig.GAME_ID
    }), Bugsense.addExtraData("dst", TGL.getDistributionPartner())),
    GameConfig.TGS.ENABLED ? (GameConfig.TGS.ENABLED && (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, 'TGSLoaded calling TGS.addEventListener("ready", TGL.initializeGame)'), TGS.addEventListener("ready", TGL.initializeGame)), TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Calling TGS.Init - synchronously"), TGS.Init(GameConfig), GameConfig.NATIVE_APP ? (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Setting up deviceready event listener to call TGL.TGSLoaded"), document.addEventListener("deviceready", TGL.TGSLoaded, !1)) : window.addEventListener ? (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Setting up windows.addEventListener to call TGL.TGSLoaded"), window.addEventListener("load", TGL.TGSLoaded, !1)) : (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Setting up windows.attachEvent to call TGL.TGSLoaded"), window.attachEvent("onload", TGL.TGSLoaded))) : GameConfig.NATIVE_APP ? (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Setting up deviceready event listener to call TGL.initializeGame"), document.addEventListener("deviceready", TGL.initializeGame, !1)) : "complete" === document.readyState ? TGL.initializeGame() : window.addEventListener ? (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Setting up windows.addEventListener to call TGL.initializeGame"), window.addEventListener("load", TGL.initializeGame, !1)) : (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Setting up windows.attachEvent to call TGL.initializeGame"), window.attachEvent("onload", TGL.initializeGame))
},
...
TGL.initializeGame = function() { ! TGL.RanGame && GameConfig.ADS.PRELOADER_PLACEMENT_ID ? TGS.Advertisement._DisplayPreloaderAd({
        parentDiv: document.body,
        closeCallback: TGL.displaySplashScreen
    }) : TGL.displaySplashScreen(),
    GameConfig.TGE.ENABLED ? TGL.initializeTGE() : (TGL.logLoadTime(), TGL.onReady && TGL.onReady())
},
TGL.displaySplashScreen = function() {
    TGS._DisplaySplashScreen && TGS._DisplaySplashScreen()
},
TGL.initializeTGE = function() {
    ...
    }), GameConfig.NATIVE_APP || !GameConfig.GoogleAnalytics.ENABLED || GameConfig.GoogleAnalytics.STUDIO_ONLY || TGL.logLoadTime(), GameConfig.TGS.ENABLED && TGS.GameLaunched()) : (TGL.Debug.Log(TGL.Debug.LOG_ERROR, "Game can not be played on this platform"), GameConfig.NATIVE_APP || !GameConfig.GoogleAnalytics.ENABLED || GameConfig.GoogleAnalytics.STUDIO_ONLY || _gaTreSensa("TGLTracker.send", {
        hitType: "event",
        eventCategory: "error",
        eventAction: "platform not supported",
        eventLabel: GameConfig.GoogleAnalytics.LABEL,
        dimension1: TGL.getDistributionPartner(),
        dimension2: GameConfig.VERSION,
        dimension3: GameConfig.GAME_ID,
        nonInteraction: !0
...
TGL.logLoadTime = function() {
    var a = Math.round(((new Date).getTime() - _loadStartTime) / 1e3);
    a > 0 && 900 > a ? (_gaTreSensa("TGLTracker.send", {
        hitType: "event",
        eventCategory: "game",
        eventAction: "load",
        eventLabel: GameConfig.GoogleAnalytics.LABEL,
        ...
        dimension3: GameConfig.GAME_ID,
        nonInteraction: !0
    }), TGS.Analytics.logGameEvent("load", a, {
        settings: {
            GoogleAnalytics: {
                nonInteraction: !0
            }
        ...
        hitType: "event",
        eventCategory: "error",
        eventAction: "game load time > 15 minutes",
        eventLabel: GameConfig.GoogleAnalytics.LABEL,
        dimension1: TGL.getDistributionPartner(),
        dimension2: GameConfig.VERSION,
        dimension3: GameConfig.GAME_ID,
...
TGL.getMoreGamesURL = function() {
    ...
    // a || b && "NA" != b && "A0000" != b || (a = "http://www.mobilewebarcade.com"),
    a
},
