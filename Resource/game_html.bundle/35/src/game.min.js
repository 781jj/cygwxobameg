...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("", "Arial", 12); // 底部文字
	...
	Pi: function() {
		...
		dp_submitScore(a);
		b = _.sprintf("You built a %d storey building", a, y.c.Gf());
		A.Ia("end", "score", a);
		b = new y.c.oe(b, "Replay",
		function() {
			//this.fg(a)
			this.Oj();
		}.bind(this), "Share", //更多游戏
		function() {
			//this.fg(a);
			//this.Rc()
			this.pj();
	...
	fg: function() {
		var a = this.Xp = new y.c.oe("", "Replay", this.Oj.bind(this), "Share", this.pj.bind(this));
		this.addChild(a);
		x.Pd(a)
	},
	Oj: function() {
