...
JSON || (JSON = {}), function() {
	...
	function str(a, b) {
		...
		case "object":
			...
			if (rep && typeof rep == "object") {
				f = rep.length;
				for (c = 0; c < f; c += 1) d = rep[c], typeof d == "string" && (e = str(d, i), e && g.push(quote(d) + (gap ? ": " : ":") + e))
			} else for (d in i) Object.prototype.hasOwnProperty.call(i, d) && (e = str(d, i), e && g.push(quote(d) + (gap ? ": " : ":") + e));
			return e = g.length === 0 ? "{}" : gap ? "{\n" + gap + g.join(",\n" + gap) + "\n" + h + "}" : "{" + g.join(",") + "}", gap = h, e
		}
	}
	var cx, escapable, gap, indent, meta, rep;
	"use strict", typeof Date.prototype.toJSON != "function" && (Date.prototype.toJSON = function() {
	...
	}), Object.prototype.toJSONString || (Object.prototype.toJSONString = function(a) {
		return JSON.stringify(this, a)
	}, Object.prototype.parseJSON = function(a) {
