...
(function(){
    ...
    publicResourceLoader =new PublicResourceLoader({
        css:['3D_running_bear_files/index.css?version='+Math.random()],
        scripts:[
            '3D_running_bear_files/jquery.min.js',
            '3D_running_bear_files/server.js?version='+Math.random(),
            '3D_running_bear_files/adSceneInGames.js?version='+Math.random(),
            '3D_running_bear_files/game_index.js?version='+Math.random()
        ]
    });
}());
