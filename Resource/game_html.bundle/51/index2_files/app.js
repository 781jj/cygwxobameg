...
function homeScreen() {
    help = new createjs.Bitmap('http://mmbiz.qpic.cn/mmbiz/kG4NuD28mG8cvbsSJCZIJDq9H9UYW7Gc0a2Iva3uzb7ZqjsTXqK6wCrrubYeLic9KdFM90yzNjKwX1oHgibic9cqQ/640g');
    help.regX = 320;
    help.regY = 372;
    help.x = s50;
    help.y = h70 / 2.2;
...
function newGame() {
    roundMsg = new createjs.Text("第 " + round + "/10 弹", s05 + "px Arial", "#ffffff");
...
function bigBall() {
    ...
    scoreAll += score;
    scoreMsg.text = "总分: " + Math.floor(scoreAll / 10) + "." + scoreAll % 10;
...
function checkGame() {
    ...
    resultScore = new createjs.Text("总分: " + Math.floor(scoreAll / 10) + "." + scoreAll % 10 + " , 最准: " + Math.floor(maxScore / 10) + "." + maxScore % 10, s10 + "px Arial", "#ff0");
    resultScore.textAlign = 'center';
    resultScore.x = screenWidth / 2;
    resultScore.y = 0.55 * screenHeight;
    stage.addChild(resultScore);
    resultMax = new createjs.Text("纪录:  " + Math.floor(hisScore / 10) + "." + hisScore % 10 + " , " + Math.floor(hisMax / 10) + "." + hisMax % 10, s10 * .8 + "px Arial", "#fff");
